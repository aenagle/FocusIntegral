...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        taskList->setGeometry(QRect(490, 50, 281, 391));
        QFont font1;
        font1.setPointSize(11);
        taskList->setFont(font1);
        taskList->setStyleSheet(QString::fromUtf8("background-color: rgbrgbrgb(202, 225, 223);"));
        startButton = new QPushButton(centralwidget);
        startButton->setObjectName("startButton");
        startButton->setGeometry(QRect(40, 400, 191, 31));
        QFont font2;
        font2.setPointSize(13);
        startButton->setFont(font2);
        deleteTaskButton = new QPushButton(centralwidget);
        deleteTaskButton->setObjectName("deleteTaskButton");
        deleteTaskButton->setGeometry(QRect(610, 490, 181, 31));
        deleteTaskButton->setFont(font2);
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(110, 130, 351, 201));
        QFont font3;
        font3.setFamilies({QString::fromUtf8("Arial")});
        font3.setPointSize(83);
        font3.setBold(false);
        ...
        taskInput->setGeometry(QRect(490, 450, 281, 26));
        QFont font4;
        font4.setPointSize(12);
        taskInput->setFont(font4);
        restButton = new QPushButton(centralwidget);
        restButton->setObjectName("restButton");
        restButton->setGeometry(QRect(260, 400, 191, 31));
        restButton->setFont(font2);
        addTaskButton = new QPushButton(centralwidget);
        addTaskButton->setObjectName("addTaskButton");
        addTaskButton->setGeometry(QRect(430, 490, 181, 31));
        addTaskButton->setFont(font2);
        lineEdit = new QLineEdit(centralwidget);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(60, 340, 371, 21));
        QFont font5;
        ...
        currentTaskLabel->setGeometry(QRect(70, 110, 341, 41));
        QFont font6;
        font6.setPointSize(15);
        font6.setItalic(false);
        font6.setUnderline(false);
        currentTaskLabel->setFont(font6);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        restButton->setText(QCoreApplication::translate("MainWindow", "\320\236\321\202\320\264\320\276\321\205\320\275\321\203\321\202\321\214", nullptr));
